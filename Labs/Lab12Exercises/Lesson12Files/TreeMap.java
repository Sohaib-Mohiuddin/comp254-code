...
public class TreeMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  /**
   * A specialized version of the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.com.opsdevelop.teaching.Labs.Lab9Exercises.Lesson9Files.LinkedBinaryTree class with
  ...
  protected static class BalanceableBinaryTree<K,V>
    ...
    // this extends the inherited com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.com.opsdevelop.teaching.Labs.Lab9Exercises.Lesson9Files.LinkedBinaryTree.Node class
    ...
    /**
     * Rotates com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position p above its parent.  Switches between these
    ...
    /**
     *
     * Returns the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position that becomes the root of the restructured subtree.
     *
  ...
  public TreeMap() {
    super();                  // the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.AbstractSortedMap constructor
  ...
  public TreeMap(Comparator<K> comp) {
    super(comp);              // the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.AbstractSortedMap constructor
    tree.addRoot(null);       // create a sentinel leaf as root
  }
   ...
   * @return com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position holding key, or last node reached during search
   */
  ...
  /**
   * Returns position with the minimal key in the subtree rooted at com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position p.
   * @param p  a com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position of the tree serving as root of a subtree
   * @return com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position with minimal key in subtree
   */
   ...
   * @param p  a com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position of the tree serving as root of a subtree
   * @return com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position with maximum key in subtree
   */
  ...
  // additional behaviors of the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.SortedMap interface
  /**
   ...
   * @param p the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position which was recently accessed (possibly a leaf)
   */
  ...
  {
	  //create a Binary Search com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.com.opsdevelop.teaching.Labs.Lab9Exercises.Lesson9Files.Tree and make a search
