...
/**
 * An abstract base class to ease the implementation of the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Map interface.
 *
...
public abstract class AbstractMap<K,V> implements Map<K,V> {
  ...
  /**
   * A concrete implementation of the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Entry interface to be used
   * within a com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Map implementation.
   */
  protected static class MapEntry<K,V> implements Entry<K,V> {
    ...
    // public methods of the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Entry interface
    public K getKey() { return k; }
    public V getValue() { return v; }

    // utilities not exposed as part of the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Entry interface
