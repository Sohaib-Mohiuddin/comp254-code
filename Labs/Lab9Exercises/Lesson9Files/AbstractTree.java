...
import com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Queue;
...
public abstract class AbstractTree<E> implements Tree<E> {
  ...
  /** Returns the number of levels separating com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position p from the root.
   *
   * @param p A valid com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position within the tree
   * @throws IllegalArgumentException if p is not a valid com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position for this tree.
   */
  ...
  /**
   * Returns the height of the subtree rooted at com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position p.
   *
   * @param p A valid com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position within the tree
   * @throws IllegalArgumentException if p is not a valid com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position for this tree.
   */
