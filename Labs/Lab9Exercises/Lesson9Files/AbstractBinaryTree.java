...
import com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.BinaryTree;
...
/**
 * An abstract base class providing some functionality of the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.com.opsdevelop.teaching.Labs.Lab9Exercises.Lesson9Files.BinaryTree interface.
 *
...
public abstract class AbstractBinaryTree<E> extends AbstractTree<E>
  ...
  /**
   * Returns the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position of p's sibling (or null if no sibling exists).
   *
   * @param p A valid com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position within the tree
   * @return the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position of the sibling (or null if no sibling exists)
  ...
  /**
   * Adds positions of the subtree rooted at com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position p to the given
   * snapshot using an inorder traversal
   * @param p       com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position serving as the root of a subtree
