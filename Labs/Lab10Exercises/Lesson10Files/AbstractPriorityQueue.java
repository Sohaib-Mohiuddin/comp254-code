...
import com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.DefaultComparator;
import com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Entry;
...
public abstract class AbstractPriorityQueue<K,V> implements PriorityQueue<K,V> {
  ...
  /**
   * A concrete implementation of the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Entry interface to be used within
  ...
  protected static class PQEntry<K,V> implements Entry<K,V> {
    ...
    // methods of the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Entry interface
