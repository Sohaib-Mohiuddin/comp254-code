package com.opsdevelop.teaching.Labs.Lab10Exercises.Lesson10Files;/*
...
public class LinkedPositionalList<E> implements PositionalList<E> {
  ...
  private static class Node<E> implements Position<E> {
    ...
    public E getElement() throws IllegalStateException {
      if (next == null)                         // convention for defunct node
        throw new IllegalStateException("com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position no longer valid");
      return element;
    }
   ...
   *
   * @param p   a com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position (that should belong to this list)
  ...
  /**
   * Returns the given node as a com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position, unless it is a sentinel, in which case
  ...
  private class PositionIterator implements Iterator<Position<E>> {
    ...
    /** A com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position of the containing list, initialized to the first position. */
    private Position<E> cursor = first();   // position of the next element to report
    /** A com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position of the most recent element reported (if any). */
