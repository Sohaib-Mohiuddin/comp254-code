...
public class UnsortedPriorityQueue<K,V> extends AbstractPriorityQueue<K,V> {
  ...
  /**
   * Returns the com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position of an entry having minimal key.
   * This should only be called on a nonempty priority queue
   * @return com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position of entry with minimal key
   */
  ...
  public static void main(String[] args)
  {
	  ...
	  System.out.println("com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Entry with minimal key: (" +queue.min().getKey() +
			  ", " + queue.min().getValue() + ")" );
	  //
  }
