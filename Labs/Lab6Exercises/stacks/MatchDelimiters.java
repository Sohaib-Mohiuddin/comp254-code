...
public class MatchDelimiters {
  ...
  public static boolean isMatched(String expression) {
    ...
    for (char c : expression.toCharArray()) {
      ...
      {
        buffer.push(c);
        System.out.println("this is a left delimiter");
        System.out.println(buffer);
      }
      
      else if (closing.indexOf(c) != -1) {        // this is a right delimiter
    	  System.out.println("this is a right delimiter");
  ...
  final static String[] valid = {"())"}; //invalid
    ...
    for (String s : valid)
    {
      if (!isMatched(s))
        System.out.println("Error evaluating valid: " + s);
    	  ...
    	  System.out.println("Valid expression: " + s);
    }
