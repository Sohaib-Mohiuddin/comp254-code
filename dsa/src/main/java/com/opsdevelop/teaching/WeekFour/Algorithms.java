package com.opsdevelop.teaching.WeekFour;

import com.opsdevelop.teaching.utils.JsonReader;
...
public class Algorithms {
    ...
    public static void linearSearch(String keyName, int target) {
        ...
        try {
            arr = JsonReader.readJsonArray(keyName); // 2 primitive operation (variable initialization)
            if (arr.length > 0) {
...
//    }
    ...
    public static void selectionSort(String keyName) {
        ...
        try {
            ...
            System.out.println("Time taken: " + duration + " milliseconds"); // 3 primitive operations (string concatenation, output)
        } catch (IOException e) {
            logger.error("An error occurred:", e);
        }
    }
