...
public class Ruler {
  ...
  public static void main(String[] args) {
    System.out.print("\n\ncom.opsdevelop.teaching.Labs.Lab5Exercises.Lesson5Files.Ruler of length 2 with major tick length 4\n");
    drawRuler(2, 4);
    System.out.print("\n\ncom.opsdevelop.teaching.Labs.Lab5Exercises.Lesson5Files.Ruler of length 1 with major tick length 5\n");
    drawRuler(1, 5);
    System.out.print("\n\ncom.opsdevelop.teaching.Labs.Lab5Exercises.Lesson5Files.Ruler of length 3 with major tick length 3\n");
    drawRuler(3, 3);
  }
}
