...
public class FavoritesList<E> {
  ...
  // nonpublic utilities
  /** Provides shorthand notation to retrieve user's element stored at com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position p. */
  protected E value(Position<Item<E>> p) { return p.getElement().getValue(); }

  /** Provides shorthand notation to retrieve count of item stored at com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position p. */
  protected int count(Position<Item<E>> p) {return p.getElement().getCount();}

  /** Returns com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position having element equal to e (or null if not found). */
  ...
  /** Moves item at com.opsdevelop.teaching.Labs.Lab12Exercises.Lesson12Files.Position p earlier in the list based on access count. */
